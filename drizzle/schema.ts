import { pgTable, foreignKey, unique, serial, text, integer, json, timestamp, numeric, boolean, uuid, index, primaryKey } from "drizzle-orm/pg-core"
...
export const prescriptions = pgTable("prescriptions", {
	...
	unique("prescriptions_firebase_id_unique").on(table.firebaseId),
]);
...
export const lensOrders = pgTable("lens_orders", {
	...
	foreignKey({
			...
			name: "lens_orders_prescription_id_prescriptions_id_fk"
		}),
	foreignKey({
			columns: [table.saleId],
			foreignColumns: [sales.id],

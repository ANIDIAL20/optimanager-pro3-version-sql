...
import { serializeFirestoreData } from './serialize-timestamps';
  ...
  const fetchDocs = useCallback(async () => {
    ...
    try {
      ...
      snapshot.forEach(doc => {
        const serializedData = serializeFirestoreData(doc.data() as T);
    ...
    const unsubscribe = onSnapshot(
      ...
      (error: FirestoreError) => {
        ...
        try {
          ...
          console.warn("Failed to create context error", err);
          setError(error);
        }

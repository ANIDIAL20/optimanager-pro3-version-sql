...
export default function ClientDetailView() {
    ...
    const clientRef = useMemoFirebase(
        () => (firestore && user ? doc(firestore, `stores/${user.uid}/clients`, id) : null),
        [firestore, user, id]
    );
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-destructive">
                        Impossible de charger le client. Vérifiez vos règles de sécurité Firestore ou votre connexion internet.
                    </p>
                </CardContent>
            </Card>
        );

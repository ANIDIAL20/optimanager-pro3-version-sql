import { pgTable, serial, text, timestamp, boolean, decimal, integer, json, primaryKey } from 'drizzle-orm/pg-core';
...
// Main users table - stores authentication credentials
...
// OAuth accounts (future extensibility)
